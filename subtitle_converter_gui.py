...
class ConverterFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.reload.SetBitmap(
            wx.Bitmap(filePath("resources", "icons", "reload.png"), wx.BITMAP_TYPE_ANY)
        )
        ...
        self.export_zip = wx.MenuItem(
            ...
            "Izvezi u zip formatu",
            wx.ITEM_NORMAL,
        )
        self.export_zip.SetBitmap(
            wx.Bitmap(
                filePath("resources", "icons", "zip_file.png"), wx.BITMAP_TYPE_ANY
            )
        )
        ...
        self.cut = wx.MenuItem(
            self.edit, wx.ID_CUT, "&Cut\t" + keyS["Cut"], "Cut text", wx.ITEM_NORMAL
        )
        ...
        self.copy = wx.MenuItem(
            self.edit, wx.ID_COPY, "&Copy\t" + keyS["Copy"], "Copy text", wx.ITEM_NORMAL
        )
        ...
        self.find = wx.MenuItem(
            self.edit, wx.ID_FIND, "&Find\t" + keyS["Find"], "Find text", wx.ITEM_NORMAL
        )
        self.find.SetBitmap(
            wx.Bitmap(filePath("resources", "icons", "search.png"), wx.BITMAP_TYPE_ANY)
        )
        ...
        self.to_ansi.SetBitmap(
            wx.Bitmap(filePath("resources", "icons", "go-next.png"), wx.BITMAP_TYPE_ANY)
        )
        ...
        self.cleaner.SetBitmap(
            wx.Bitmap(
                filePath("resources", "icons", "edit-clear-all.png"), wx.BITMAP_TYPE_ANY
            )
        )
        ...
        self.merger.SetBitmap(
            wx.Bitmap(filePath("resources", "icons", "merge.png"), wx.BITMAP_TYPE_ANY)
        )
        ...
        self.fixer_settings = wx.MenuItem(
            self.preferences,
            wx.ID_ANY,
            "&FixerSettings\t" + keyS["FixerSettings"],
            wx.EmptyString,
            wx.ITEM_NORMAL,
        )
        self.fixer_settings.SetBitmap(
            wx.Bitmap(
                filePath("resources", "icons", "dialog-settings.png"),
                wx.BITMAP_TYPE_ANY,
            )
        )
        ...
        self.shortcuts.SetBitmap(
            wx.Bitmap(
                filePath("resources", "icons", "input-keyboard.png"), wx.BITMAP_TYPE_ANY
            )
        )
        ...
        self.merger_pref.SetBitmap(
            wx.Bitmap(
                filePath("resources", "icons", "merge-settings.png"), wx.BITMAP_TYPE_ANY
            )
        )
        ...
        self.about.SetBitmap(
            wx.Bitmap(
                filePath("resources", "icons", "help-about.png"), wx.BITMAP_TYPE_ANY
            )
        )
        ...
        self.manual = wx.MenuItem(
            self.help, wx.ID_ANY, "&Manual\t" + keyS["Manual"], "Manual", wx.ITEM_NORMAL
        )
        self.manual.SetBitmap(
            wx.Bitmap(wx.ArtProvider.GetBitmap(wx.ART_HELP_PAGE, wx.ART_MENU))
        )
        ...
        self.frame_toolbar.AddTool(
            ...
            "Cirilica",
            wx.Bitmap(
                filePath("resources", "icons", "cyrillic.png"), wx.BITMAP_TYPE_ANY
            ),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "U cirilicu",
        ...
        self.frame_toolbar.AddTool(
            1003,
            "ANSI",
            wx.Bitmap(filePath("resources", "icons", "ANSI.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "U ansi",
            "U ansi",
        ...
        self.frame_toolbar.AddTool(
            1004,
            "UTF",
            wx.Bitmap(filePath("resources", "icons", "UTF8.png"), wx.BITMAP_TYPE_ANY),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "U utf-8",
            "U utf-8",
        ...
        self.frame_toolbar.AddTool(
            ...
            "Transcribe",
            wx.Bitmap(
                filePath("resources", "icons", "cyr-ltr.24.png"), wx.BITMAP_TYPE_ANY
            ),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "Transcribe",
        ...
        self.frame_toolbar.AddTool(
            ...
            "Cleanup",
            wx.Bitmap(
                filePath("resources", "icons", "editclear.png"), wx.BITMAP_TYPE_ANY
            ),
            wx.NullBitmap,
            wx.ITEM_NORMAL,
            "Cleanup",
