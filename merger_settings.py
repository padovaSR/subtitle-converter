...
class Settings(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        self.sizer_6.Add(
            (20, 20), 1, wx.ALIGN_BOTTOM | wx.ALIGN_RIGHT | wx.ALL | wx.EXPAND, 3
        )
        self.sizer_6.Add(
            self.button_1, 1, wx.ALIGN_BOTTOM | wx.ALIGN_RIGHT | wx.ALL | wx.EXPAND, 3
        )
        self.sizer_6.Add(
            self.button_2,
            1,
            wx.ALIGN_BOTTOM | wx.ALIGN_RIGHT | wx.BOTTOM | wx.EXPAND | wx.LEFT | wx.TOP,
            3,
        )
